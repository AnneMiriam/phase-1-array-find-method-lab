...
function superbowlWin(array) {
    // my argument for the function is an array of objects
    // I'm looking for a result that is === W
    // So I told my function to .find() a result === W in my array
    const result = array.find(win => win.result === 'W');
    // my func is to return that results year if result === W
    // the func will return undefined if it does not
    return result ? result.year : undefined;
}
// ! win and array in this func are parameters 
// ! that represent my record [array]
